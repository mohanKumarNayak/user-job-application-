...
function NodeJsApplication(props){
    ...
    return (
        <div className="container">
            <div className="row">
                ...
                <h2 className="display-4">Node.js Developers</h2>
                <h2 className="display-4" style={{fontSize:"30px"}}>List of candidtaes applied for Node.js Developers job</h2>
                ...
                <tbody>
                    {
                        props.applications.map(appliction=>{
                            if(appliction.jobTitle == "Node.js Developer"){
                                return (
...
export default connect(mapStateToProps)(NodeJsApplication)