...
function FullStackApplication(props){
    ...
    return (
        <div className="container">
            <div className="row">
                ...
                <h2 className="display-4">Full Stack Developers</h2>
                <h2 className="display-4" style={{fontSize:"30px"}}>List of candidtaes applied for Full Stack Developers job</h2>
                ...
                <tbody>
                    {
                        props.applications.map(appliction=>{
                            if(appliction.jobTitle == "FULL Stack Developer"){
                                return (
